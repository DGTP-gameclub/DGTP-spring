...
screen about():
    ...
    use game_menu(_("크레딧"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("""{a=https://www.renpy.org/}Ren'Py{/a}로 만들어진 게임입니다. 버전 [renpy.version_only].

            대광고 게임동아리, DGTP의 초도작입니다. 많이 즐겨주시면 감사하겠습니다.
            
            참 많은 분들이 저희를 도와주셨습니다. 이 자리를 빌어 감사의 마음 전합니다.
            음악 : Jayt2n        유투브 크리에이터 스튜디오
            사진 : 김예람 선배    pixabay
            공간 : 대광고(이승현 선생님)
                         p.s. 교사용 컴에 포토샵이랑 에펙 깔아서 죄송합니다.
                         재부팅 안되는 컴이 거기밖에 없어서 그랬어요...

            미디어 재처리 : 어도비 만세! 학생할인 좀 더 해주시오!
            아예 고딩 이하는 매달 만원 이하로 해주면 좋겠소!
            
            얘들아 수고했다! 정말 잘 따라줘서 고맙고 활동 꼬박꼬박 나와줘서 감동했다!
            앞으로 더욱 야자 많이 빼줄 수 있도록 노력할게!
